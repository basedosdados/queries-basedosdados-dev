...
with
    censo as (
        ...
        from `basedosdados-dev.br_inep_censo_escolar_staging.escola`
    ),
    ...
    censo_2023 as (
        ...
        from `basedosdados-dev.br_inep_censo_escolar_staging.escola_2023`
    ),
    censo_2024 as (
        select
            safe_cast(ano as int64) ano,
            ...
            safe_cast(quantidade_turma_noturno as int64) quantidade_turma_noturno,
            safe_cast(quantidade_turma_ead as int64) quantidade_turma_ead
        from `basedosdados-dev.br_inep_censo_escolar_staging.escola_2024`
    )
