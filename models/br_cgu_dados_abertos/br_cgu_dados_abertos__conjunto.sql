...
select
    ...
    safe_cast(nullif(id_organizacao_responsavel, "") as string) id_organizacao_responsavel,
    ...
    extract(date from safe.parse_datetime('%d/%m/%Y %T',  data_atualizacao)) data_atualizacao,
