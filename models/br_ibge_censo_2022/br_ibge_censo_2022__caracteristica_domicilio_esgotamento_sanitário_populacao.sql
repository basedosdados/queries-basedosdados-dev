{{
    config(
        alias="caracteristica_domicilio_esgotamento_sanitário_populacao",
...
from
    `basedosdados-dev.br_ibge_censo_2022_staging.morador_cor_raca_esgotamento_sanitario_municipio`
    as t
