...
with
    domicilio_morador as (
        ...
        from `basedosdados-dev.br_ibge_censo_2022_staging.municipio`
    ),
    ...
    area as (
        ...
        from `basedosdados-dev.br_ibge_censo_2022_staging.municipio_area` as t
    ),
    ...
    indice_envelhecimento as (
        ...
        from
            `basedosdados-dev.br_ibge_censo_2022_staging.municipio_indice_envelhecimento`
    ),
    ...
    indigenas as (
        ...
        from `basedosdados-dev.br_ibge_censo_2022_staging.municipio_indigenas`
        group by 1, 2
    ),
    ...
    quilombolas as (
        ...
        from `basedosdados-dev.br_ibge_censo_2022_staging.municipio_quilombolas`
        group by 1, 2
    ),
...
left join
    `basedosdados-dev.br_ibge_censo_2022_staging.auxiliary_table` as auxiliary_table
