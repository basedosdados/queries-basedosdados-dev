{{
    config(
        alias="caracteristica_domicilio_canalizacao_abastecimento_agua",
...
from
    `basedosdados-dev.br_ibge_censo_2022_staging.domicilio_canalizacao_abastecimento_agua_municipio`
    as t
